...
namespace BrunoLau.SpaServices.Prerendering
{
    ...
    public class RenderToStringResult
    {
        ...
        {
            if (Globals == null || Globals.Value.ValueKind == JsonValueKind.Null || Globals.Value.ValueKind == JsonValueKind.Undefined)
            {
                return string.Empty;
            }
            ...
            foreach (var property in Globals.Value.EnumerateObject())
            {
