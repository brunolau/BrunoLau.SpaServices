module.exports = (callback, applicationBasePath, bootModule, absoluteRequestUrl, requestPathAndQuery, customDataParameter, overrideTimeoutMilliseconds) => {
    ...
    var renderToStringImpl = function (callback, applicationBasePath, bootModule, absoluteRequestUrl, requestPathAndQuery, customDataParameter, overrideTimeoutMilliseconds) {
        try {
    ...
    var findBootModule = function (applicationBasePath, bootModule) {
    ...
    var findRenderToStringFunc = function (applicationBasePath, bootModule) {
    ...
    var isLegacyAspNetPrerendering = function () {
        var version = getAspNetPrerenderingPackageVersion();
        return version && /^1\./.test(version);
    }

    var getAspNetPrerenderingPackageVersion = function () {
        try {
    ...
    renderToStringImpl(callback, applicationBasePath, bootModule, absoluteRequestUrl, requestPathAndQuery, customDataParameter, overrideTimeoutMilliseconds);
}